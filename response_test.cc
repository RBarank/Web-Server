...
TEST(StockResponse, BadRequest) 
{
  ...
  EXPECT_EQ(test_response.GetResponseCode(), Response::BAD_REQUEST);
  EXPECT_NO_THROW(test_response.ToString());
}
...
TEST(StockResponse, OK) 
{
  ...
  EXPECT_EQ(test_response.GetResponseCode(), Response::OK);
  EXPECT_NO_THROW(test_response.ToString());
...
TEST(StockResponse, BadGateway) 
{
  ...
  EXPECT_EQ(test_response.GetResponseCode(), Response::BAD_GATEWAY);
  EXPECT_NO_THROW(test_response.ToString());
...
TEST(StockResponse, NotModified) 
{
  ...
  EXPECT_EQ(test_response.GetResponseCode(), Response::NOT_MODIFIED);
  EXPECT_NO_THROW(test_response.ToString());
...
TEST(StockResponse, NotFound) 
{
  ...
  EXPECT_EQ(test_response.GetResponseCode(), Response::NOT_FOUND);
  EXPECT_NO_THROW(test_response.ToString());
}
...
TEST(StockResponse, Created) 
{
  ...
  EXPECT_EQ(test_response.GetResponseCode(), Response::CREATED);
  EXPECT_NO_THROW(test_response.ToString());
}
...
TEST(StockResponse, Accepted) 
{
  ...
  EXPECT_EQ(test_response.GetResponseCode(), Response::ACCEPTED);
  EXPECT_NO_THROW(test_response.ToString());
}
...
TEST(StockResponse, NoContent) 
{
  ...
  EXPECT_EQ(test_response.GetResponseCode(), Response::NO_CONTENT);
  EXPECT_NO_THROW(test_response.ToString());
}
...
TEST(StockResponse, MultipleChoices) 
{
  ...
  EXPECT_EQ(test_response.GetResponseCode(), Response::MULTIPLE_CHOICES);
  EXPECT_NO_THROW(test_response.ToString());
}
...
TEST(StockResponse, Forbidden) 
{
  ...
  EXPECT_EQ(test_response.GetResponseCode(), Response::FORBIDDEN);
  EXPECT_NO_THROW(test_response.ToString());
}
...
TEST(StockResponse, MovedPerm) 
{
  ...
  EXPECT_EQ(test_response.GetResponseCode(), Response::MOVED_PERMANENTLY);
  EXPECT_NO_THROW(test_response.ToString());
}
...
TEST(StockResponse, MovedTemp) 
{
  ...
  EXPECT_EQ(test_response.GetResponseCode(), Response::MOVED_TEMPORARILY);
  EXPECT_NO_THROW(test_response.ToString());
}
...
TEST(StockResponse, Unauthorized) 
{
  ...
  EXPECT_EQ(test_response.GetResponseCode(), Response::UNAUTHORIZED);
  EXPECT_NO_THROW(test_response.ToString());
}
...
TEST(StockResponse, InternalError) 
{
  ...
  EXPECT_EQ(test_response.GetResponseCode(), Response::INTERNAL_SERVER_ERROR);
  EXPECT_NO_THROW(test_response.ToString());
}
...
TEST(StockResponse, NotImplemented) 
{
  ...
  EXPECT_EQ(test_response.GetResponseCode(), Response::NOT_IMPLEMENTED);
  EXPECT_NO_THROW(test_response.ToString());
}
...
TEST(StockResponse, ServiceUnavailable) 
{
  ...
  EXPECT_EQ(test_response.GetResponseCode(), Response::SERVICE_UNAVAILABLE);
  EXPECT_NO_THROW(test_response.ToString());
}
