...
all:
	g++ config_parser.cc connection.cc server.cc response.cc request.cc webserver.cc mime-types.cc request_handler.cc echo_handler.cc static_handler.cc not_found_handler.cc server_info.cc status_handler.cc -o webserver $(STD_FLAGS)
...
old_handler_test:
	g++ -std=c++11 -isystem ${GTEST_DIR}/include -pthread request_handler_test.cc request_handler.cc static_handler.cc response.cc request.cc mime-types.cc ${GTEST_DIR}/src/gtest_main.cc libgtest.a -o request_handler_test -lboost_system
