...
case `uname` in
  Linux)
    ...
    g++ -std=c++0x -isystem ${GTEST_DIR}/include -pthread server_test.cc server.cc connection.cc -lboost_system ${GTEST_DIR}/src/gtest_main.cc libgtest.a -o server_test ;;
  Darwin)
